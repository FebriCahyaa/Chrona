...
The fetch script targets the current `main` branches of Google Fonts `googlesans-flex` and Google's `material-design-icons` repository and records the resolved upstream paths in `assets/fonts/metadata.json`.
