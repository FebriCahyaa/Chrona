...
import com.febricahyaa.chrona.widget.selector.AlarmSelection
import com.febricahyaa.chrona.widget.selector.AlarmSelectionAdapter
...
class AlarmSelectionActivity : Activity() {
    ...
    companion object {
        ...
        const val EXTRA_ACTION = "com.febricahyaa.chrona.EXTRA_ACTION"
        const val EXTRA_ALARMS = "com.febricahyaa.chrona.EXTRA_ALARMS"
    }
}