...
class AlarmService : Service() {
    ...
    /** Registered while listening for call state changes, else null. */
    private var mCallStateListener: TelephonyCallback? = null
    ...
    companion object {
         ...
         * ALARM_DONE_ACTION).
         */
        const val ALARM_SNOOZE_ACTION = "com.febricahyaa.chrona.ALARM_SNOOZE"
         ...
         */
        const val ALARM_DISMISS_ACTION = "com.febricahyaa.chrona.ALARM_DISMISS"

        /** A public action sent by AlarmService when the alarm has started.  */
        const val ALARM_ALERT_ACTION = "com.febricahyaa.chrona.ALARM_ALERT"

        /** A public action sent by AlarmService when the alarm has stopped for any reason.  */
        const val ALARM_DONE_ACTION = "com.febricahyaa.chrona.ALARM_DONE"
