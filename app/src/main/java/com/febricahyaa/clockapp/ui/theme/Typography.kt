...
val ChronaTypography = Typography(
    displayLarge = TextStyle(fontSize = 56.sp, lineHeight = 58.sp, fontWeight = FontWeight.Light),
    headlineLarge = TextStyle(fontSize = 30.sp, lineHeight = 34.sp, fontWeight = FontWeight.SemiBold),
    headlineMedium = TextStyle(fontSize = 25.sp, lineHeight = 29.sp, fontWeight = FontWeight.SemiBold),
