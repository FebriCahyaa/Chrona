...
import com.febricahyaa.clockapp.core.ClockTimeMath;
...
public final class ChronaNativeBridge {
    ...
    /** Starts a generated low-latency fallback alert tone through Android AAudio. */
    public static boolean startLowLatencyAlertTone() {
        return NATIVE_READY && nativeStartLowLatencyAlertTone();
    }

    /** Stops the generated low-latency fallback alert tone. */
    public static void stopLowLatencyAlertTone() {
        if (NATIVE_READY) {
            nativeStopLowLatencyAlertTone();
        }
    }
    ...
    private static native boolean nativeStartLowLatencyAlertTone();
    private static native void nativeStopLowLatencyAlertTone();
}
