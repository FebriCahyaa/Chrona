...
object WorldClockCityCatalog {
    ...
    val entries = listOf(
        ...
        Entry("Los Angeles", "US", "America/Los_Angeles", setOf("LA", "L.A.")),
        Entry("San Francisco", "US", "America/Los_Angeles", setOf("SF", "Bay Area")),
        ...
        Entry("New Delhi", "IN", "Asia/Kolkata", setOf("Delhi")),
        Entry("Mumbai", "IN", "Asia/Kolkata", setOf("Bombay")),
